...
from dataset import get_datasets, PEMSDataset
...
GRAPH_FEATURES_FN = partial(spectral_features, embed_size=12)
...
class DatasetAdapter(Dataset):
    def __init__(self, dataset: PEMSDataset, graph_construction_fn, graph_features_fn=None):
        super().__init__()
...
with open("spectral_gcn_study_results.pkl", "wb") as f:
